...
type OffsetCheckpointFeature struct {
	...
	MaxOffsetCheckpointEmissionDelay *duration.Duration `protobuf:"bytes,1,opt,name=max_offset_checkpoint_emission_delay,json=maxOffsetCheckpointEmissionDelay,proto3" json:"max_offset_checkpoint_emission_delay,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *OffsetCheckpointFeature) GetMaxOffsetCheckpointEmissionDelay() *duration.Duration {
	if x != nil {
...
const file_com_daml_ledger_api_v2_version_service_proto_rawDesc = "" +
	...
	"\x13GetLedgerApiVersion\x122.com.daml.ledger.api.v2.GetLedgerApiVersionRequest\x1a3.com.daml.ledger.api.v2.GetLedgerApiVersionResponseB\x92\x01\n" +
	"\x16com.daml.ledger.api.v2B\x18VersionServiceOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
