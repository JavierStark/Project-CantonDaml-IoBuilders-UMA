...
type VettedPackage struct {
	...
	// lower bound.
	ValidFromInclusive *timestamp.Timestamp `protobuf:"bytes,2,opt,name=valid_from_inclusive,json=validFromInclusive,proto3" json:"valid_from_inclusive,omitempty"`
	// The time until which this package is vetted. Empty if vetting time has no
	// upper bound.
	ValidUntilExclusive *timestamp.Timestamp `protobuf:"bytes,3,opt,name=valid_until_exclusive,json=validUntilExclusive,proto3" json:"valid_until_exclusive,omitempty"`
...
func (x *VettedPackage) GetValidFromInclusive() *timestamp.Timestamp {
	if x != nil {
...
func (x *VettedPackage) GetValidUntilExclusive() *timestamp.Timestamp {
	if x != nil {
...
func (x *PriorTopologySerial) GetNoPrior() *empty.Empty {
	if x != nil {
...
type PriorTopologySerial_NoPrior struct {
	...
	NoPrior *empty.Empty `protobuf:"bytes,2,opt,name=no_prior,json=noPrior,proto3,oneof"`
}
...
const file_com_daml_ledger_api_v2_package_reference_proto_rawDesc = "" +
	...
	"\x06serialB\x94\x01\n" +
	"\x16com.daml.ledger.api.v2B\x1aPackageReferenceOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
