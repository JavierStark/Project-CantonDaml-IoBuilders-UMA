...
func (x *CreatedEvent) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
const file_com_daml_ledger_api_v2_event_proto_rawDesc = "" +
	...
	"\tacs_delta\x18\x0f \x01(\bR\bacsDeltaB\x89\x01\n" +
	"\x16com.daml.ledger.api.v2B\x0fEventOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
