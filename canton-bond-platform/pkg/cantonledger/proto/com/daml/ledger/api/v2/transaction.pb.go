...
type Transaction struct {
	...
	// Required
	EffectiveAt *timestamp.Timestamp `protobuf:"bytes,4,opt,name=effective_at,json=effectiveAt,proto3" json:"effective_at,omitempty"`
	...
	// Required
	RecordTime *timestamp.Timestamp `protobuf:"bytes,9,opt,name=record_time,json=recordTime,proto3" json:"record_time,omitempty"`
...
func (x *Transaction) GetEffectiveAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *Transaction) GetRecordTime() *timestamp.Timestamp {
	if x != nil {
		return x.RecordTime
	}
	return nil
...
const file_com_daml_ledger_api_v2_transaction_proto_rawDesc = "" +
	...
	"\x16com.daml.ledger.api.v2B\x15TransactionOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
