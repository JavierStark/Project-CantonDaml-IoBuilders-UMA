...
type SynchronizerTime struct {
	...
	// Required
	RecordTime    *timestamp.Timestamp `protobuf:"bytes,2,opt,name=record_time,json=recordTime,proto3" json:"record_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SynchronizerTime) GetRecordTime() *timestamp.Timestamp {
	if x != nil {
		return x.RecordTime
	}
	return nil
...
const file_com_daml_ledger_api_v2_offset_checkpoint_proto_rawDesc = "" +
	...
	"recordTimeB\x94\x01\n" +
	"\x16com.daml.ledger.api.v2B\x1aOffsetCheckpointOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
