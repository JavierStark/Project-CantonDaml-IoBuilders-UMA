...
func (x *Value) GetUnit() *empty.Empty {
	if x != nil {
...
type Value_Unit struct {
	...
	Unit *empty.Empty `protobuf:"bytes,1,opt,name=unit,proto3,oneof"`
}
...
const file_com_daml_ledger_api_v2_value_proto_rawDesc = "" +
	...
	"\x16com.daml.ledger.api.v2B\x0fValueOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
