...
type Reassignment struct {
	...
	// Required
	RecordTime *timestamp.Timestamp `protobuf:"bytes,7,opt,name=record_time,json=recordTime,proto3" json:"record_time,omitempty"`
...
func (x *Reassignment) GetRecordTime() *timestamp.Timestamp {
	if x != nil {
		return x.RecordTime
	}
	return nil
...
type UnassignedEvent struct {
	...
	// Optional
	AssignmentExclusivity *timestamp.Timestamp `protobuf:"bytes,8,opt,name=assignment_exclusivity,json=assignmentExclusivity,proto3" json:"assignment_exclusivity,omitempty"`
...
func (x *UnassignedEvent) GetAssignmentExclusivity() *timestamp.Timestamp {
	if x != nil {
...
const file_com_daml_ledger_api_v2_reassignment_proto_rawDesc = "" +
	...
	"\x16com.daml.ledger.api.v2B\x16ReassignmentOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
