...
type Commands struct {
	...
	// Optional
	MinLedgerTimeAbs *timestamp.Timestamp `protobuf:"bytes,7,opt,name=min_ledger_time_abs,json=minLedgerTimeAbs,proto3" json:"min_ledger_time_abs,omitempty"`
	...
	// Optional
	MinLedgerTimeRel *duration.Duration `protobuf:"bytes,8,opt,name=min_ledger_time_rel,json=minLedgerTimeRel,proto3" json:"min_ledger_time_rel,omitempty"`
...
func (x *Commands) GetDeduplicationDuration() *duration.Duration {
	if x != nil {
...
type Commands_DeduplicationDuration struct {
	...
	DeduplicationDuration *duration.Duration `protobuf:"bytes,5,opt,name=deduplication_duration,json=deduplicationDuration,proto3,oneof"`
}
...
const file_com_daml_ledger_api_v2_commands_proto_rawDesc = "" +
	...
	"\x16com.daml.ledger.api.v2B\x12CommandsOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
