...
func (x *Completion) GetDeduplicationDuration() *duration.Duration {
	if x != nil {
...
type Completion_DeduplicationDuration struct {
	...
	DeduplicationDuration *duration.Duration `protobuf:"bytes,8,opt,name=deduplication_duration,json=deduplicationDuration,proto3,oneof"`
}
...
const file_com_daml_ledger_api_v2_completion_proto_rawDesc = "" +
	...
	"\x16com.daml.ledger.api.v2B\x14CompletionOuterClassZEcanton-bond-platform/pkg/cantonledger/proto/com/daml/ledger/api/v2;pb\xaa\x02\x16Com.Daml.Ledger.Api.V2b\x06proto3"
