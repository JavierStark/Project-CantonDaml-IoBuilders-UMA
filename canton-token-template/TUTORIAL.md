...
## 6. The Transfer Factory Interface
...
## 7. The Allocation & Settlement Interfaces
...
## 8. Our Implementation: SimpleToken.Holding
  ...
  where
    ...
    choice LockedSimpleHolding_Unlock : ContractId SimpleHolding
      ...
      do
        ...
        create SimpleHolding with admin; owner; instrumentId; amount;
          couponRate; maturityDate; description; meta
...
## 10. The Factory Contract: SimpleTokenRules
...
## 11. Two-Step Transfer: SimpleTransferInstruction
...
## 12. DvP Settlement: SimpleAllocation
